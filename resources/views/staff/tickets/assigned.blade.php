                                        ...
                                        <div class="space-y-1">
                                            <div class="flex min-w-0 items-center gap-2">
                                                ...
                                                <div class="min-w-0 text-xs">
                                                    ...
                                                    <span class="inline-block max-w-[9rem] truncate align-bottom font-medium text-slate-700">{{ $ticket->user->name ?? 'Unknown' }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex min-w-0 items-center gap-2">
                                                ...
                                                <div class="min-w-0 text-xs">
                                                    ...
                                                    <span class="inline-block max-w-[9rem] truncate align-bottom font-medium text-slate-700">{{ $ticket->assignedTechnician->name ?? 'Unknown' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
